...
exports.alerts = (req, res, next) => {
  ...
  if (alert === 'booking') {
    res.locals.alert = 'You booking was successful! Please check your email'
                       + ' for a confirmation. If your booking doesn\'t show'
                       + ' up here immidiatly, plese come back later.';
  }
  next();
}
